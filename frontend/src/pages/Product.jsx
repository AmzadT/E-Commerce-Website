                  ...
                  <div className="flex gap-2">
                       {
                         productData.sizes.map((item, index) => (
                            <button onClick={()=> setSize(item)} className={`border rounded-md py-2 px-4 bg-gray-100 ${item === size ? 'border-orange-500' : '' }`} key={index}>{item}</button>
                         ))
                       }
                  </div>
            </div>
      ...
      {/* Description & Review Section */}
       ...
       <div className="mt-20">
            ...
            <div className="flex flex-col gap-4 text-gray-500 border px-6 py-6 text-sm">
              <p>Discover the ultimate blend of style and comfort with our premium cotton T-shirt. Designed for everyday wear, this lightweight and breathable fabric keeps you feeling fresh all day long. Whether you're dressing up or keeping it casual, its versatile design pairs perfectly with any outfit. Available in a range of colors, this must-have wardrobe essential offers durability and easy care. Elevate your style effortlessly with this classic piece.</p>
